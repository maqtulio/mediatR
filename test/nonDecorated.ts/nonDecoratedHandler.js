...
let NonDecoratedTestCommandCommandHandler = class NonDecoratedTestCommandCommandHandler extends IHandler {
    constructor() {
        super(...arguments);
...
NonDecoratedTestCommandCommandHandler = __decorate([
    CommandHandler(NonDecoratedTestCommand)
], NonDecoratedTestCommandCommandHandler);
export { NonDecoratedTestCommandCommandHandler };
